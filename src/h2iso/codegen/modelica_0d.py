...
'''
    ...
    return f'''\
package Generic_ISS_Adapters
  "Multi-Component 5D/6D Adapters for Generic_ISS Hydrogen Isotope Separation System"

  // ========================================================================
  // 多组分适配器外壳 (Multi-Component Adapter Shells)
  // 将 5 维原子质量流 [T, D, H, He, Imp] (g/h) 映射为 6 维分子流 [H2..T2]
  // ========================================================================
  ...
  equation
    ...
    core.feed_TEP[2] = 0.0;
    core.feed_TEP[3] = 0.0;
    core.feed_TEP[4] = 0.25 * n_tot * MW[4]; // D2 (0.5 n_T * MW_D2)
    core.feed_TEP[5] = 0.50 * n_tot * MW[5]; // DT (n_T * MW_DT)
    core.feed_TEP[6] = 0.25 * n_tot * MW[6]; // T2 (0.5 n_T * MW_T2)
